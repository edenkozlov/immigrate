...
function renderInput(id, label, maxLength, placeholder) {
  return (
    <div>
...
function renderDropdown(id, label, options, placeholder) {
  return (
    <div>
      <label htmlFor={`dropdown-${id}`}>{label}</label>
      <select id={`dropdown-${id}`} style={DropdownStyle}>
